        ...
        <SafeAreaView style={{ flex: 1 }}>
            <ScrollView style = {{ width: '90%', alignSelf: 'center' }}>
                ...
                <View style = {{ marginTop: 20, flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-around', width: '100%'}}>
                    <TouchableOpacity style = {{ marginVertical: 10, width: 140, height: 140, borderRadius: 20, borderWidth: 3, borderColor: '#F2F2F2', alignItems: 'center', justifyContent: 'center', backgroundColor: '#2B5353' }}>
